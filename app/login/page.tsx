    ...
    <AuthLayout>
      <div className="glass rounded-2xl p-8 border border-white/10 neon-border">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Sign in to access your capstone projects</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button
            type="submit"
            disabled={isDisabled}
            className="w-full h-12 bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-500 hover:from-purple-500 hover:via-blue-500 hover:to-cyan-400 text-white font-semibold shadow-lg shadow-purple-500/25 group disabled:opacity-50"
          >
            {isLoading ? (
              <>
